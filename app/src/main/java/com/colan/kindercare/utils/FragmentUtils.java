...
public class FragmentUtils {
    ...
    static final int TRANSITION_POP = 0;
    static final int TRANSITION_FADE_IN_OUT = 1;
    static final int TRANSITION_SLIDE_LEFT_RIGHT = 2;
    static final int TRANSITION_SLIDE_LEFT_RIGHT_WITHOUT_EXIT = 3;
    static final int TRANSITION_NONE = 4;
